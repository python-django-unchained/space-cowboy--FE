...
export default function IceGiantRoom(props) {
    ...
    useEffect(() => {
        axiosWithAuth()
            ...
            .then(res => {  
                ...
                axiosWithAuth().post('/api/adv/changeplanet', {planet: 'Mordor', roomId: newRoom.id}).then(res => console.log(res)).catch(err => console.log(err.response))
